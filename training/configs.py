...
def build_config(config_name, job_id):
    ...
    if config_name == "default":
        ...
        CONFIG = {
            ...
            "FILTER_SIZE_LAYER_1": 20,
            "FILTER_SIZE_LAYER_2": 20,
            "FILTER_SIZE_LAYER_3": 20,
            "FILTER_SIZE_LAYER_4": 20,
            "FILTER_SIZE_LAYER_5": 19,
            "FILTER_SIZE_LAYER_6": 17,
            "FILTER_SIZE_LAYER_7": 15,
            "FILTER_SIZE_LAYER_8": 13,
            "FILTER_SIZE_LAYER_9": 11,
            "FILTER_SIZE_LAYER_10": 9,
